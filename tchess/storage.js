...
if (DATABASE_URL) {
  ...
  impl = { getUser, getUserByEmail, createUser, upsertUser, addGameRecord, getGames, mode: "postgres" };
} else {
  /* ---------------------------------------------------------
  ...
  impl = { getUser, getUserByEmail, createUser, upsertUser, addGameRecord, getGames, mode: "json" };
}
